    ...
    private void setDatas(List<OnlineSaleBean> onlineSaleBeanList, int type) {
        if (onlineSaleBeanList.size() > 0) {
            ...
            for (int i = 0; i < onlineSaleBeanList.size(); i++) {
                ...
                tableMode.setOrgCode( "我啊");
                tableMode.setLeftTitle( "公司名字"+i);
                tableMode.setText0(onlineSaleBean.getOrgCode() + "---1---");//列0内容
                tableMode.setText1(onlineSaleBean.getAreaName() + "---2---");//列1内容
                tableMode.setText2(onlineSaleBean.getSaleAll() + "---3---");//列2内容
                tableMode.setText3(onlineSaleBean.getSaleAllOneNow() + "---4---");
                tableMode.setText4(onlineSaleBean.getSaleAllLast() + "---5---");
                tableMode.setText5(onlineSaleBean.getSaleAllOneNowLast() + "---6---");//
                tableMode.setText6(onlineSaleBean.getSaleAllRate() + "---7---");//
                tableMode.setText7(onlineSaleBean.getSaleAllOneNowRate() + "---8---");//
                tableMode.setText8(onlineSaleBean.getRetailSale() + "---9---");//
                tableMode.setText9(onlineSaleBean.getRetailSaleOneNow() + "---10---");//
                tableMode.setText10(onlineSaleBean.getRetailSaleLast() + "---11---");//
                tableMode.setText11(onlineSaleBean.getRetailSaleOneNowLast() + "---12---");//
